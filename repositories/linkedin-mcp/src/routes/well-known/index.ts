...
const baseManifest = {
  ...
  description_for_human:
    "Busca candidatos en LinkedIn, envía InMails personalizados, y gestiona tu pipeline de reclutamiento con IA.",
  description_for_model:
    "Utiliza herramientas de reclutamiento de LinkedIn para buscar candidatos, rankear perfiles, generar mensajes personalizados y gestionar pipeline de hiring.",
  auth: {
    type: "oauth",
